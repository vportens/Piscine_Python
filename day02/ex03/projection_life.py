...
def main():
    path = ("../data python piscine/"
            "income_per_person_gdppercapita_ppp_inflation_adjusted.csv")
    data_life_time = load('../data python piscine/life_expectancy_years.csv')
    data_gdp = load(path)
    ...
    plt.scatter(merged_data['1900_gdp'], merged_data['1900_life'], alpha=0.5)
